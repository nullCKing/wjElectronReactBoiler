      ...
      <div className="entry-tile" style={leftTileStyle}>
        ...
        <div className="entry">
          <div className="checkbox-container">
            ...
            <label className="checkbox-label" htmlFor="unlistedIndustry">Toggle unlisted industry parameter</label>
          </div>
          <div className="checkbox-container">
            ...
            <label className="checkbox-label" htmlFor="unlistedLocation">Toggle unlisted location parameter</label>
          </div>
          <div className="checkbox-container">
            ...
            <label className="checkbox-label" htmlFor="unlistedPrice">Toggle unlisted price parameter</label>
          </div>
        </div>
        ...
        <div className="entry">
          <div className="checkbox-container">
            ...
            <label className="checkbox-label" htmlFor="sunbeltNetwork">Toggle Sunbelt Network</label>
          </div>
          <div className="checkbox-container">
            ...
            <label className="checkbox-label" htmlFor="synergy">Toggle Synergy</label>
          </div>
        </div>
